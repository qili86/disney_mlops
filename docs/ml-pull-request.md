...
Opening a pull request will trigger a[workflow](../.github/workflows/disney_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://uc-demo.cloud.databricks.com/explore/data/models/staging/disney_mlops/disney_mlops-model)
* [Prod model in UC](https://uc-demo.cloud.databricks.com/explore/data/models/prod/disney_mlops/disney_mlops-model)
. 
