...
##################################################################################
# Model Training Notebook using Databricks Feature Store --- new feature abc
#
...
# ``disney_mlops/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.disney.disney_mlops-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.disney.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.disney.trip_dropoff_features",
