...
git add README.md docs .gitignore disney_mlops/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://uc-demo.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://uc-demo.cloud.databricks.com#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[disney_mlops/databricks.yml](../disney_mlops/databricks.yml) file.
...
Follow the instructions in [disney_mlops/resources/README.md](../disney_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../disney_mlops/resources/README.md)  to propose, test, and deploy
